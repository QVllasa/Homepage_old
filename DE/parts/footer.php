    ...
    <div class="row align-items-center pt-5">
      <div class="container  ">
        <div class="row justify-content-center">
          ...
          <a>|</a>
          <a href="https://qendrimvllasa.com">

            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                 xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                 viewBox="0 0 512 512" style="enable-background:new 0 0 512 512; height:15px; cursor:pointer; "
                 xml:space="preserve">
<circle style="fill:#F0F0F0;" cx="256" cy="256" r="256"/>
		...
		l-97.802,97.803V189.219z"/>
          ...
          <a href="https://qendrimvllasa.de">

            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                 xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                 viewBox="0 0 512 512" style="enable-background:new 0 0 512 512; height:15px; cursor: pointer;" xml:space="preserve">
<path style="fill:#FFDA44;" d="M15.923,345.043C52.094,442.527,145.929,512,256,512s203.906-69.473,240.077-166.957L256,322.783
	...
	C506.368,317.31,512,287.314,512,256s-5.632-61.31-15.923-89.043H15.923z"/>
        ...
        <div class="row justify-content-center mt-1">
          <p>&copy; Qendrim Vllasa 2019. All rights Reserved.</p>
        </div>
      </div>
    </div>
  </div>
