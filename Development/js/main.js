...
$(document).ready(function () {
  if(window.location.hash){
    var $str1 = window.location.hash;
    console.log($str1);
    $('.computerzusammenbau-blogs').collapse('show');
...
$('a[id*="-blogs"]').on('click', function () {
  let tartget = this.id;
  window.location = "/hobbys.php#".concat(tartget);
  console.log("/hobbys.php#".concat(tartget));
});
